<?php
/**
 * Vehicle_Search_Plugin Test Bootstrapper.
 *
 * @since   1.0
 ...
 * @since 1.0
 */
function _manually_load_vehicle_search_plugin_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/vehicle-search-plugin.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_vehicle_search_plugin_plugin' );
